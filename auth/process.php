    ...
    if (isset($_POST['type'])) {
        ...
        if ($_POST['type'] == 'register') {
            ...
            if (!($password == $password2)) {
                $error = new ErrorResponse(500, "Passwords Don't Match", "http://".$_SERVER['HTTP_HOST']."/auth/register.php");
            ...
            if ($insert) {
                $response = new SuccessResponse(201, "Registration Successful", "http://" . $_SERVER['HTTP_HOST'] ."/auth/login.php");
            ...
            if ($check_login[0]) {
                ...
                $userResp = new ErrorResponse(401, "Incorrect email or password", "http://" . $_SERVER['HTTP_HOST'] ."/auth/login.php");
